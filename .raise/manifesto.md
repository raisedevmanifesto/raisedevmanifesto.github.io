...
We believe software development is entering a new era—one where powerful AI assistants are partners in creation, not mere tools. But left unchecked, AI veers off course, dilutes clarity, and creates unmaintainable systems. We created RAISE to do the opposite: amplify the developer's intent, enforce quality, and move fast without breaking things.

RAISE emerges from the ongoing evolution of software development. From the early days of machine code and assembly, through the development of procedural, functional, and object-oriented paradigms, each advancement has provided new ways to manage complexity and express developer intent. AI-assisted development, when grounded by rules and driven by artifacts of intention, represents a new chapter in this ongoing story of abstraction and empowerment.

**Rules provide structure. AI amplifies execution. Intention guides purpose.**

RAISE—Rules and AI for Intention-driven Software Engineering—is a development methodology that combines structured guidance, purpose-driven planning, and artifact-based execution. It emphasizes clarity over chaos, intention over scope creep, and meaningful collaboration between humans and AI.
...
7. **Commit Messages** - Structured records of changes using [Conventional Commits](https://www.conventionalcommits.org/), capturing the "why" behind each modification.
...
### AI Collaboration
RAISE leverages AI throughout the development lifecycle:
- **Ideation**: AI helps articulate and refine the initial vision.
- **Design**: AI generates and iterates on design concepts.
- **Development**: AI assists with implementation while following human direction.
- **Documentation**: AI helps maintain living, up-to-date artifacts.

This collaborative approach ensures that human creativity and judgment remain central, while AI handles execution details and repetitive tasks.
...
**The RAISE Solution**: AI serves as a documentation guardian, continuously monitoring the relationship between artifacts and implementation. When inconsistencies emerge:

1. **Proactive Detection**: AI identifies when code changes drift from documented intentions
2. **Update Suggestions**: AI proposes specific documentation updates that align with implementation changes
3. **Human Validation**: Developers review and approve these changes, ensuring artifacts remain accurate while preserving human ownership
...
This approach transforms documentation from a static liability into a dynamic asset that reflects current reality while preserving clear intention. By delegating the mechanical aspects of documentation maintenance to AI while keeping humans as the arbiters of correctness, RAISE eliminates one of the fundamental tensions in software engineering.

## Open Questions

As RAISE evolves, we're exploring several key areas:

1. **Balancing Vision and Adaptability**
   - Maintaining clarity while incorporating new insights

2. **Human-AI Collaboration**
   - Optimizing the division of labor between human creativity and AI execution

3. **Practical Implementation**
   - Scaling the methodology across different project types and team sizes
   - Determining essential vs. optional artifacts

4. **Success Metrics**
   - Measuring alignment between vision and implementation
   - Evaluating the effectiveness of AI collaboration
